...
def generatePDF(content, pdf_file):
    ...
    if os.path.isfile(pdf_file):
        os.remove(pdf_file)
    pdfkit.from_string(
        args.style + "<style>:global {font-size: 7px !important; font-family: 'monospace' !important;}* {font-size: 7px !important; font-family: 'monospace' !important;}:root {--global-font-size: 7px; --global-font-family: 'monospace';}</style>" + content,
        pdf_file,
        options=pdf_options,
    )
